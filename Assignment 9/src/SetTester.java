...
//      //test 1111
//        ISet<String> s111 = new UnsortedSet<String>();
//        s1.clear();
//        System.out.println(s1);
//        
//        if( s1.equals(s111))
//            System.out.println("Passed test 111: clear methods UnsortedSet");
//        else
//            System.out.println("Failed test 111: cear methods UnsortedSet");

        
        //test 2
        s1.remove("A");
        System.out.println(s1);
        if (s1.contains("C") && s1.contains("C"))
//        if( !s1.contains("A") )
